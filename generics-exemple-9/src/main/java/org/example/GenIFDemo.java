...
class GenIFDemo {
    public static void main(String[] args) {
        ...
        ClassMinMax<Integer> iOb = new ClassMinMax<Integer>(inums);
        ClassMinMax<Character> cOb = new ClassMinMax<Character>(chrs);
        ...
        System.out.println("Максимальное значение в массиве chrs: " + cOb.max());
        System.out.println("Минимальное значение в массиве chrs: " + cOb.min());
    }
}
/* -------------------------------------
